...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("SdetHybrid1 Test Project"); //title of the report
		htmlReporter.config().setReportName("Functional tyest report"); //name of the report
	...
	public void onTestFailure(ITestResult tr)
	{
	 ...
	 public void onFinished(ITestContext textContext)
	 {
		 extent.flush();
	 }
}
